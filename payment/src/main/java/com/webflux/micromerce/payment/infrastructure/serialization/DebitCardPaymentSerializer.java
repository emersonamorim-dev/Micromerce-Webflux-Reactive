...
import com.webflux.micromerce.payment.domain.model.DebitCardPayment;
import com.webflux.micromerce.payment.domain.service.PaymentDataGenerator;

import java.io.IOException;

public class DebitCardPaymentSerializer extends StdSerializer<DebitCardPayment> {

    public DebitCardPaymentSerializer() {
        super(DebitCardPayment.class);
    }

    @Override
    public void serialize(DebitCardPayment payment, JsonGenerator gen, SerializerProvider provider) throws IOException {
