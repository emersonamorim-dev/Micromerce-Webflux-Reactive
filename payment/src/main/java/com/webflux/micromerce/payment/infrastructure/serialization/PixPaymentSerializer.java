...
import com.webflux.micromerce.payment.domain.model.PixPayment;
import com.webflux.micromerce.payment.domain.service.PaymentDataGenerator;

import java.io.IOException;

public class PixPaymentSerializer extends StdSerializer<PixPayment> {

    public PixPaymentSerializer() {
        super(PixPayment.class);
    }

    @Override
    public void serialize(PixPayment payment, JsonGenerator gen, SerializerProvider provider) throws IOException {
        ...
        // Preserve a chave e o tipo PIX originais
        gen.writeStringField("pixKey", payment.getPixKey());
        gen.writeStringField("pixKeyType", payment.getPixKeyType());
